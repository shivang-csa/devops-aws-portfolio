# 1. The S3 Bucket for Website Files
resource "aws_s3_bucket" "website_bucket" {
  bucket = "my-portfolio-site-unique-2026" # CHANGE THIS
}
...
# 4. The CloudFront Distribution (CDN)
...
# 5. The S3 Bucket Policy (Binds CloudFront to S3)
